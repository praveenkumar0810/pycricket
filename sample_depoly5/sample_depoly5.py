...
def for_six():
	...
	com_for_six = ['Good cricket all round','Just over the fielder',
	'Thats a hugeeeee hit!','That’s a screamer',
	'Excellent batting conditions',
	'That’s massive and out of the ground','Maxxxxximumm',
	'What a lovely shot!...its six',
	'Only he can play that shot','Thats huge ',
	'Thats a maximum']
